  ...
  subroutine ca_ext_src(lo,hi,&
    ...
    use amrex_constants_module, only : ZERO, TWO, HALF!, ONE, SEVEN, FIFTH, TENTH
    !use bl_constants_module, only: ZERO, HALF, ONE, SEVEN, FIFTH, TENTH
