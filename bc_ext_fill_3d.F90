...
!print *,"check [x]", adv_l1, domlo(1)
!print *,"check [y]", adv_l2, domlo(2)
!print *,"check [z]", adv_l3, domlo(3)
!    print *, "domlo", domlo(3),domhi(3), adv_l3, adv_h3
!    print *, "rho", adv(domlo(1),domlo(2),adv_l3:domlo(3)+1,URHO)
!    print *, "T", adv(domlo(1),domlo(2),adv_l3:domlo(3)+1,UTEMP)
!    print *, "dense above", adv(domlo(1),domlo(2),domlo(3),URHO),adv(domlo(1),domlo(2),domlo(3),UTEMP)
       ! ZLO
    ...
    enddo
 !   print *, "after rho", adv(domlo(1),domlo(2),adv_l3:domlo(3)+1,URHO)
 !   print *, "after T  ", adv(domlo(1),domlo(2),adv_l3:domlo(3)+1,UTEMP)
 !   print *, "after e", adv(domlo(1),domlo(2),adv_l3:domlo(3)+1,UEINT)
 !   print *, "after ee",adv(domlo(1),domlo(2),adv_l3:domlo(3)+1,UEDEN)
